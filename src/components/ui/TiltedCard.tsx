        ...
        >
            {showMobileWarning && (
                <div className="absolute top-4 text-center text-sm block sm:hidden text-white/50">
                    Este efeito não é otimizado para mobile. Confira no desktop.
                </div>
            )}
            ...
            {showTooltip && (
                <motion.figcaption
                    className="pointer-events-none absolute left-0 top-0 rounded-[4px] bg-white px-[10px] py-[4px] text-[10px] text-[#2d2d2d] opacity-0 z-[3] hidden sm:block font-medium"
                    style={{
                        x,
                        y,
                        opacity,
