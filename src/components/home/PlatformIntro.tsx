...
export function PlatformIntro() {
    return (
        <section id="platform" className="snap-start snap-proximity scroll-smooth w-full min-h-screen bg-[#05050A] flex flex-col items-center justify-center relative border-t border-white/5 py-20 md:py-0 md:h-screen">
            {/* Background Effects */}
            ...
            <div className="md:hidden w-full h-full flex flex-col items-center justify-start relative z-10 px-4 pt-8 pb-20">
                ...
                >
                    <div className="flex flex-col items-center mb-4">
                        <span className="text-3xl font-bold bg-clip-text text-transparent bg-gradient-to-r from-purple-400 via-blue-400 to-pink-500 mb-3 leading-tight">
                            Apresentamos
                        </span>
                        <div className="relative">
                            <img
                                className="w-28 drop-shadow-[0_0_30px_rgba(255,255,255,0.2)]"
                    ...
                    <p className="text-xs text-gray-300 leading-relaxed max-w-sm mx-auto font-light px-2">
                ...
                <motion.div
                    ...
                    className="w-full max-w-sm shadow-[0_0_50px_rgba(168,85,247,0.15)] rounded-2xl"
                >
                    <TiltedCard
            ...
            {/* Desktop Layout */}
            <div className="hidden md:block max-w-7xl mx-auto px-6 relative z-10 w-full h-full">
                    ...
                    <div className="relative z-10 text-center pointer-events-none flex flex-col items-center">
                        ...
                        >
                            <div className="flex flex-col items-center mb-6">
                                <span className="text-7xl font-bold bg-clip-text text-transparent bg-gradient-to-r from-purple-400 via-blue-400 to-pink-500 mb-6 leading-tight">
                                    Apresentamos
                                </span>
                                <div className="relative">
                                    <img
                                        className="w-60 drop-shadow-[0_0_30px_rgba(255,255,255,0.2)]"
                                        src="/Eleva1_Prancheta 1.png"
                                        alt="Eleva Logo"
                                    />
                                    <div className="absolute -inset-4 bg-purple-500/10 blur-2xl rounded-full -z-10" />
                            ...
                            <p className="text-2xl text-gray-300 leading-relaxed max-w-2xl mx-auto font-light">
                                Onde a <span className="text-white font-medium">criação</span> encontra a potência da <span className="text-white font-medium">gestão avançada</span>.
                            </p>
                        </motion.div>
                    </div>
