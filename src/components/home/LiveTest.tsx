                ...
                <div className="relative flex flex-1 gap-6 overflow-hidden">
                    ...
                    <div className="ml-24 flex-1 flex flex-col overflow-hidden relative">
                        ...
                        {hasChanges && (
                            ...
                            >
                                <div className="pointer-events-auto flex items-center gap-3 px-5 py-4 rounded-2xl bg-slate-900/95 border border-yellow-400/40 shadow-2xl backdrop-blur-xl">
                                    <AlertCircle className="h-6 w-6 text-yellow-400 shrink-0" />
                                    <p className="text-sm md:text-base text-yellow-100">
                                        Clique em <span className="font-semibold">Salvar</span> para
                                        ver as alterações na Home.
                                    </p>
                                </div>
                            </motion.div>
                        )}
                            ...
                            <div className="flex-1 overflow-y-auto pr-2 space-y-6">
                                ...
                                <div className="rounded-lg border border-white/10 bg-white/5 backdrop-blur-md shadow-xl">
                                    <div className="flex flex-col border-b border-white/10 bg-white/5 px-6 py-4">
                                        <div className="flex items-center gap-2">
                                            ...
                                            <h3 className="text-base font-semibold text-white">Estrutura da Seção</h3>
                                        </div>
                                        <p className="text-sm text-slate-400 mt-1.5">Defina quais elementos estarão visíveis nesta seção</p>
                                    </div>
                                                    ...
                                                    >
                                                        <div className="flex items-center justify-between">
                                                            ...
                                                            {isLocked ? (
                                                                ...
                                                                >
                                                                    <span className={`block h-5 w-5 rounded-full bg-white shadow-sm transition-transform ${isActive ? 'translate-x-5' : 'translate-x-0.5'
                                                                        }`}></span>
                                                                </button>
                                                            )}
                                                        </div>
                                ...
                                <div className="rounded-xl border border-white/10 bg-white/5 backdrop-blur-md shadow-xl">
                                    ...
                                    >
                                        ...
                                        <ChevronRight className={`h-4 w-4 text-slate-400 transition-transform ${contentExpanded ? 'rotate-90' : ''}`} />
                                    </button>
                                            ...
                                            {elements.hasSubtitle && (
                                                <div>
                                                    ...
                                                    <input
                                                        type="text"
                                                        value={subtitle}
                                                        onChange={(e) => handleTextChange(e.target.value, setSubtitle)}
