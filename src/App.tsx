...
function App() {
  return (
    <HeroProvider>
      <div className="bg-[#05050A] text-white font-['Satoshi'] selection:bg-purple-500 selection:text-white h-dvh min-h-dvh w-full snap-container overflow-y-auto overflow-x-hidden snap-y snap-mandatory scroll-smooth relative">
